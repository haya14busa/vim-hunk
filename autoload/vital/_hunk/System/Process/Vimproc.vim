...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hunk#System#Process#Vimproc#import() abort
  ...
  execute join(['function! vital#_hunk#System#Process#Vimproc#import() abort', printf("return map({'_vital_depends': '', 'execute': '', 'is_supported': '', 'is_available': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
