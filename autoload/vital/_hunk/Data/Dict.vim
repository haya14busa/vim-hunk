...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hunk#Data#Dict#import() abort
  ...
  execute join(['function! vital#_hunk#Data#Dict#import() abort', printf("return map({'pick': '', 'clear': '', 'max_by': '', 'foldl': '', 'swap': '', 'omit': '', 'min_by': '', 'foldr': '', 'make_index': '', 'make': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
